    ...
    <body>
        <center>
            ...
            <div class="video-wrap">
                <video id="video" playsinline autoplay style="border-radius:10px; margin-top:35px"></video>
            </div>

            <!-- Trigger canvas web API -->
            <div class="controller">
            <a id="snap" class="btn btn-secondary" style="margin-top:20px; background-color:#004E8B;">Tomar Foto</a>
            </div>
            ...
            <canvas id="canvas" width="500" height="250" style="border-radius:10px; margin-top:35px"></canvas>
        </center>
