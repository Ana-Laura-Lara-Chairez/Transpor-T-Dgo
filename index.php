...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            ...
            <h2 style="color: #FFFFFF;">Una nueva forma de pagar el transporte público</h2>
            <div class="d-flex">
                <a href="nosotros.php" class="btn-get-started scrollto">Conoce más sobre nosotros</a>
            </div>
        </div>
    </section>
    <!-- End Hero -->
                    ...
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="assets/img/credencial1.png" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="assets/img/credencial2.png" alt="">
                            </div>
                        </div>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="info-box  mb-4">
                        ...
                        <p><a href="mailto:info@yoursite.com">transportdgodgo.mx@gmail.com
                            </a></p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        ...
                        <p>
                            ...
                            <strong>Email:</strong>transportdgodgo.mx@gmail.com<br>
                        </p>
                    </div>
