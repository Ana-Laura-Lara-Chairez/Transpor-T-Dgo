    ...
    <section id="featured-services" class="featured-services">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <h3>Rutas <span>Disponibles</span></h3>
                <p>Estas son las principales rutas disponibles en la ciudad</p>
            </div>
            ...
            <div class="row">
                ...
                while ($campo = mysqli_fetch_array($resultado)) {
                    ...
                    $id  = $campo['id_ruta'];
                    $nombre = $campo['nom_ruta'];
                    $descripcion = $campo['dec_ruta'];
                    $pt1 = "./admin/";
                    $pt2 = $campo['fot_ruta'];
                    $dir = $pt1 . $pt2;


                    echo ('<div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-5">
                            <div class="icon-box text-center" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <center><hr class="hr-rutas"></center>
                                <p class="description" style="text-align:justify;">' . $descripcion . '</p>
                                <a class="btn btn-secondary" style="margin-top:20px; background-color:#004E8B;" href="rutas-individuales.php?id=' . $id .'">Ver Más</a>
                            </div>
                        </div>');
                }
                ?>
