...
<body>
            ...
            <center>
                <div class="contenedor-saldo" data-aos="fade-right" data-aos-delay="100">
                        <div class="icon-box text-center" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <a class="btn btn-secondary" style="margin-top:20px; background-color:#004E8B;" data-bs-toggle="modal" data-bs-target="#modal1">Recargar</a>
                                             </div>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Selecciona la opcion para recargar saldo</h5>
    ...
    <div class="row">
      ...
      <div class="col-md-4 ">
          ...
          <h6>Tarjeta de credito o debito</h6>
                                    ...
                                    <div class="d-flex justify-content-center">
       <img src="https://cdn-icons-png.flaticon.com/512/2695/2695969.png" width="60%"  >
       </div>
 <div class="d-flex justify-content-center mt-4 ">
                ...
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modal2">Seleccionar</button>
...
<div class="d-flex justify-content-center">
             <img src="https://cdn-icons-png.flaticon.com/512/1771/1771174.png"     width="60%"  >
           </div>
 <div class="d-flex justify-content-center mt-4 ">
 <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#modal3">Seleccionar</button>
                </div>            </div>
            <div class="col-md-4 ">
                <div class="d-flex justify-content-center">
                                          <h6>Deposito a cuenta del beneficiario</h6>
                                          </div>
                <div class="d-flex justify-content-center">
             <img src="https://cdn-icons-png.flaticon.com/128/2984/2984670.png" width="60%"  >
             </div>
                <div class="d-flex justify-content-center mt-4 ">
...
<div class="modal fade" id="modal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <label for="exampleInputEmail1">Numero de la tarjeta</label>
    <input type="text" class="form-control" id="exampleInputEmail1"  placeholder="Ingresa el umero de la tarjeta">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1"> Caduca</label>
    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Caduca">
  </div>
  
  <div class="form-group mb-4">
    <label for="exampleInputPassword1"> Ingresa la cantidad a depositar</label>
...
<div class="modal fade" id="modal3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <label for="exampleInputEmail1">Clabe interbancaria para realizar el la transferencia</label>

  </div>
  
  <div class="form-group">
      
    <label for="exampleInputEmail1">058597000007563885</label>
...
<div class="modal fade" id="modal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="form-group">
    ...
    <label for="exampleInputEmail1">Cuenta para realizar el la transferencia</label>
